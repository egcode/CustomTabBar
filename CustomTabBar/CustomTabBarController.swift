...
//    }
    ...
    private func setupCircleButtons() {
        ...
        button4.addTarget(self, action: #selector(CustomTabBarController.button4Pressed), forControlEvents: .TouchUpInside)
        ...
        button5.addTarget(self, action: #selector(CustomTabBarController.button5Pressed), forControlEvents: .TouchUpInside)
